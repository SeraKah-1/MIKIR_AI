...
export const GlassButton: React.FC<GlassButtonProps> = ({ 
  ...
  const baseStyles = "relative px-6 py-3 rounded-2xl font-medium transition-all duration-300 backdrop-blur-md border shadow-lg active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed";
