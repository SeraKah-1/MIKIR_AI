...
import { Gamepad2, CheckCircle2, Circle, Shuffle, Play, Layers } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto pt-8 pb-24 px-4 min-h-[80vh]">
      <div className="text-center mb-10">
         <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}>
           <h1 className="text-3xl font-bold text-slate-800 flex items-center justify-center">
             <Gamepad2 className="mr-3 text-violet-500" size={32} /> Virtual Room
           </h1>
           <p className="text-slate-500 mt-2">
             Pilih beberapa kuis lama untuk membuat <span className="text-violet-600 font-bold">Ujian Campuran (Mixer)</span>.
           </p>
         </motion.div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
         ...
         <div className="md:col-span-2 space-y-3 max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
            {history.length === 0 && (
               <div className="text-center p-10 border-2 border-dashed border-slate-200 rounded-3xl text-slate-400">
               ...
               return (
                 ...
                 >
                    <div className="flex items-center space-x-4">
                       ...
                       <div>
                          <h3 className={`font-semibold text-sm ${isSelected ? 'text-violet-900' : 'text-slate-700'}`}>
                            {quiz.fileName}
                          </h3>
                    ...
                    <div className="pr-2">
                       {isSelected 
                         ? <CheckCircle2 className="text-violet-500" size={24} />
         ...
         <div className="md:col-span-1">
            <div className="bg-white/40 backdrop-blur-xl border border-white/60 p-6 rounded-3xl shadow-xl sticky top-6">
               ...
               <div className="space-y-3">
                 <GlassButton 
                   ...
                   className={`${selectedIds.length >= 2 ? 'bg-violet-600 text-white border-violet-500 hover:bg-violet-700' : 'opacity-50 cursor-not-allowed'}`}
                 >
